...
async def on_message(message):
           ...
           if message.content == "!환율":
                      while True:
                                 ...
                                 if ((now.hour == 23) and (now.minute == 30) and (now.second == 00)):
                                            embed = discord.Embed(title="%s년%s월%s일 %s시%s분%s초" % (now.year,now.month,now.day,now.hour + 9,now.minute + 30,now.second), description="환율 시장이 개장되었습니다.", color=0x62c1cc)
